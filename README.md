...
- [About](#about)
  ...
  * [What can I create with assemble?](#what-can-i-create-with-assemble)
- [Install](#install)
...
* Assemble is built on [base](https://github.com/node-base/base), so if you learn how to use assemble, you will know how to use other applications built on `base`, like [templates](https://github.com/jonschlinkert/templates), [verb](https://github.com/verbose/verb), [generate](https://github.com/generate/generate) and [update](https://github.com/update/update)
...
Create a [vinyl](http://github.com/wearefractal/vinyl) stream. Takes glob patterns or filepaths to the source files to read.
