...
We're happy to announce the release of Assemble v0.9.1! If you're new to assemble, the [About](#about) section and [FAQ](#faq) might be a good place to start.

**Gitter**

Want to discuss assemble? Have questions? Join the [conversation on gitter](gitter.im/assemble/assemble).
