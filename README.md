...
We're happy to announce the release of Assemble v0.8.0!
...
* Minor bump due to changes in [templates](https://github.com/jonschlinkert/templates). Please see **  v0.11.0** in [templates history](https://github.com/jonschlinkert/templates#history) for more details.
