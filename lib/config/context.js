...
module.exports = function (assemble, params) {
  ...
  assemble.context = function () {
    ...
    _.each(assemble.data, function (data) {
      ...
      params.context[name] = _.merge({}, params.context[name] || {}, data.content);
      params.context = _.merge({}, params.context, params.context[name]);
    });

    // merge the params.context and component.metadata over assemble.options
    params.context = _.merge({}, assemble.options, params.context, params.component.metadata);
