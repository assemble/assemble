...
// local
var notifier = require('../../stages/notifier');
...
var HandlebarsEngine = function (assemble, options) {
  ...
  var params = {};
  params.assemble = this.assemble;
  params.grunt = this.options.grunt || {};

  helpers.register(Handlebars, this.options, params);
};
...
HandlebarsEngine.prototype.loadDefaultLayout = function(done) {
  return layouts.loadDefaultLayout(this.assemble, done);
};

HandlebarsEngine.prototype.loadComponentLayout = function(component, done) { 
  return layouts.loadComponentLayout(this.assemble, component, done);
};
