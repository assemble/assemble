...
module.exports = {
  ...
  extend: function (Assemble) {
    ...
    /**
     * Constructor stack to be used when creating a
     * new instance of Assemble
     *
     * @type {Array}
     */
     ...
     * ```
     *
     * @param  {Function} `constructor` Function to call when creating an Assemble instance.
     * @api public
     */
  ...
  initialize: function (assemble, extensions) {
...
/**
 * Helper function to coerce `val` to an array.
 *
 * @param {*} `val`
 */
