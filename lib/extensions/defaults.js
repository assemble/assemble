...
var engineHandlebars = require('consolidate').handlebars;
...
module.exports = function (Assemble) {
  ...
  Assemble.prototype.defaultTemplates = function() {
    // defaultConfig from `template`
    Assemble.__super__.defaultTemplates.apply(this, arguments);
    this.create('file', { renameKey: function (fp) { return fp; }});
  };


  Assemble.prototype.defaultEngines = function() {
    // defaultEngines from `template`
