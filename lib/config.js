 ...
 * ## Clearing the cache
 *
 * > Methods for clearing the cache, or for removing or reseting specific values on the cache.
 *
 */
 ...
 * ## .clear
 *
 * Remove `key` from the cache, or if no value is specified the entire
 * cache is reset.
 *
 * **Example:**
 *
