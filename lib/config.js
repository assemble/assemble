...
//    .pipe(this._use(options.parse, this.parse)(options));
  return fs.src(glob, options)
    .pipe(parser());

//  var stream = fs.src(glob, options);
//
//  if (options.parse) {
//    stream.pipe(this.parse(options));
//  }
//
//  return stream;
};
...
//  return this._use(options.engine, this.engine)(options)
//    .pipe(this._use(options.route, this.route)(dest, options))
 ...
 *    .pipe(this._use(options.parse, this.parse)(options))
 *    .pipe(this._use(options.render, this.parse)(options));
 * ```
