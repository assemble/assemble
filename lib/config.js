...
function Config(context) {
   ...
   * ## .all
   *
   * List all elements on `this.context`.
   *
   * **Example**
   *
   * ```js
   ...
   * ## .keys
   *
   * List all the keys on `this.context`.
   *
   * **Example**
   *
   * ```js
...
//        // TODO: use the renamer method to namespace partials?
...
Config.prototype.dest = vfs.dest;
