...
exports.parse = function parse(file, options) {
  ...
  // Normalize paths
  obj.base = file.base || obj.base;
  obj.cwd = file.cwd || options.cwd || process.cwd();
 ...
 * ## .normalizeObject
 *
 * Normalize an object to be an Assemble file object.
 *
 * @param  {Object} `obj` The object to normalize.
 * @return {Object} Normalized file object.
 */

exports.normalizeObject = function normalizeObject(obj) {
 // todo
};
