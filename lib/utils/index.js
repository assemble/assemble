...
exports.debug = function (obj, omit) {
  var o = _.omit(obj, ['contents', '_contents', 'original'].concat(omit || []));
...
exports.getDestExt = function(file, assemble) {
  ...
  var destExt = file.ext || file.dest.ext || assemble.get('destExt');
...
/**
 * Return the engine for the `given` file.
 *
 * @param {Object} `file` A file object with `ext`/`dest` properties.
 * @param {Object} `assemble`
 * @api public
...
exports.isValidEngineExt = function(ext) {
  var lang = language.lang(exports.stripDot(ext));
