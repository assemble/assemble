...
module.exports = function (assemble) {
  ...
  return function (options) {
    ...
    var paginateOpts = extend(options.paginate || {}, {limit: 1});
    ...
    return through.obj(function (file, enc, callback) {
      ...
      pages.forEach(function (page, idx) {
        ...
        page.locals = extend(page.locals || {}, {pagination: pagination, 'debug-pagination': require('util').inspect(pagination, null, 10)});
        this.push(page);
      }.bind(this));
