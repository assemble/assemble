    ...
    assemble.src(options.template)
      .pipe(through.obj(function (templateFile, enc, cb) {
        ...
        files = files.concat(pages.map(function (page, idx) {
          ...
          file.locals = extend(file.locals || {}, {pagination: page, 'debug-pagination': require('util').inspect(page, null, 10)});
    ...
    assemble.src(options.template)
      .pipe(through.obj(function (templateFile, enc, cb) {
        ...
        collection.forEach(function (item) {
          ...
          files = files.concat(pages.map(function (page, idx) {
            var file = templateFile.clone();
            file.locals = extend(file.locals || {}, {pagination: require('util').inspect(page, null, 10)});
