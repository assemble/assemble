...
View.prototype._applyLayout = function (file, options) {
  ...
  if (this.layoutEngine) {
    ...
    var obj = this.layoutEngine.inject(str, file.layout, opts);
...
View.prototype.makePartialsObject = function (partials) {
  ...
  _.forOwn(partials, function (partial, name) {
    ...
    if (partial.contents) {
      results[name] = partial.contents.toString(this.encoding);
    }
  }.bind(this));
...
View.prototype.render = function (cb) {
  ...
  if (!file.hasLayout) {
    this._applyLayout(file, { defaultLayout: opts.layout || false });
    file.hasLayout = true;
  }
