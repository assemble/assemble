...
Layout.prototype.set = function (ext, options) {
  ext = utils.ensureExt(ext);
  var opts = _.extend({layout: 'default', ext: ext}, options);
  this.layoutEngine[ext] = new Layouts(opts);
  this.mapLayouts(ext);
  return this;
};
...
Layout.prototype.mapLayouts = function (ext) {
