...
var Line = assemble.Line = function (name, options) {
  ...
  this.plugins = this.pluginManager.resolve(this, this.options.plugins, this.options);
...
Line.prototype.build = function (callback) {
  ...
  this.pluginManager.run(this, params, callback);
};

Line.prototype.registerPlugin = function (name, description, options, fn) {
  this.pluginManager.createPlugin(name, description, options, fn, this);
};