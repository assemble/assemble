 ...
 *
 * @param  {String} src     src template to compile
 * @param  {Object} options options passed to the assemble instance when creating
 * @return {Object}         an instance of Assemble
 */

var assemble = module.exports = function (src, options) {
  return assemble.init(src, options);
};
