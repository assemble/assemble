...
Assemble.prototype.config = function () {
  // TODO
...
Assemble.prototype.src = function (glob, options) {
  ...
  options = _.extend({}, props.omitGlobProps(this.options), options);
...
Assemble.prototype.helper = function (ext, patterns) {
  debug('helper:', chalk.magenta(ext), chalk.magenta(patterns));
  return this.helpers(ext, patterns);
};
...
Assemble.prototype.helpers = function (ext, patterns, options) {
  var args = [].slice.call(arguments);
  debug('helpers:', chalk.magenta(args));
  ext = args.shift();
  var o = helpers.load.apply(helpers, args);

  this._.engines.helpers(ext).set(o.cache);
  return this._.engines.helpers(ext).get();
};
...
Assemble.prototype.registerHelper = function (ext, key, value) {
  debug('registerHelper %s', chalk.magenta(key));
  this._.engines.helpers(ext).set(key, value);
  return this;
};
...
Assemble.prototype.registerHelpers = function (ext, patterns, options) {
  this.helpers(ext, patterns, options);
  return this;
};
