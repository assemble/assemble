...
Assemble.prototype.defaultConfig = function () {
  ...
  this.parser('gray-matter', function (/*assemble*/) {
    var opts = _.extend({autodetect: true}, self.get('front matter'));
...
Assemble.prototype.cwd = function (dir) {
  ...
  var cwd = path.join.apply(path, [this.get('cwd')].concat(args))
...
Assemble.prototype._buffer = function (options) {
  options = _.extend({}, this.options, options);
