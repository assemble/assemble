...
Assemble.prototype.data = function(data, options) {
  if (!arguments.length) {
...
Assemble.prototype.read = function(config) {
...
Assemble.prototype.root = function root(data) {
...
Assemble.prototype.extendData = function extendData() {
