...
var Template = require('view-cache');
...
// Create a new Class for Assemble to inherit from
// to ensure we get all the functionality we need.
var Orch = Template.extend(Orchestrator.prototype);
Orch.extend = Template.extend;
...
Assemble.prototype.defaultParsers = function() {
  Assemble.__super__.defaultParsers.call(this);
