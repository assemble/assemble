...
Assemble.prototype.init = function(options) {
  ...
  partials = new Template({}, options);
  layouts = new Template({}, options);
...
Object.defineProperty(Assemble.prototype, 'partials', {
  ...
  set: function (value) {
    partials = new Template(value, this.options);
  }
});
...
Object.defineProperty(Assemble.prototype, 'layouts', {
  ...
  set: function (cache) {
    layouts = new Template(cache, this.options);
  }
});
