...
Assemble.prototype.partials = function (patterns, options) {
  patterns = (patterns || []).concat(this.options['partials']);
...
Assemble.prototype.layouts = function (patterns, options) {
  patterns = (patterns || []).concat(this.options['layouts']);
...
Assemble.prototype.engine = function(ext, options, fn) {
  ...
  // also create a Layout instance for this ext
  // options need to be set based on extension
  (new Layout(this)).set(ext, options);
  return this;
};
