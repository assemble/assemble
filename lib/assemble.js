...
Assemble.prototype.defaultConfig = function (options) {
  ...
  // this._cache('partials', options.partials);
  // this._cache('layouts', options.layouts);
...
Assemble.prototype._cache = function(key, value, obj) {
  this.constant(key, value, obj || this.templates);
  return this;
};
...
Assemble.prototype.render = function (file, options, callback) {
  ...
  try {
    view.render(_.extend(settings, opts), callback);
  } catch (err) {
    callback(err);
  }
};
