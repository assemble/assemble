 ...
 */
var Line = assemble.Line = function (source, options) {
  ...
  this.options = (options && options.metadata || {});
...
assemble.init = function (source, options) {
  ...
  return this.instanceCache[name] = this.instanceCache[name] || new Line(source, options);
};
